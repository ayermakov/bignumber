...
public class BigNumber {
    // BigInt stores decimal values in reverse order (value 123 is stored as {3,2,1}).
    private final short[] value;
    private boolean isNegative;

    public BigNumber(String bigIntInString, boolean negative) {
    ...
    public BigNumber add(BigNumber addedValue) {
        ...
        if(isNegative) {
            ...
            if (addedValue.isNegative()) {
                if (this.isGreaterThan(value2))
                    return calculateDistract(value, value2); //with plus flag
                else
                    return calculateDistract(value2, value); //with neg flag
            } else {
                if (this.isGreaterThan(value2))
    ...
    public BigNumber distract(BigNumber addedValue) {
        return this;
    }

    private BigNumber calculateDistract(short[] value1, short[] value2) {
        return this;
    }
    ...
    public boolean isGreaterThan(short[] anotherValue) {
